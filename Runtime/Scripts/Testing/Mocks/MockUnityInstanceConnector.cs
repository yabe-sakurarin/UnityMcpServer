...
using Sakurarin.UnityMcpServer.Runtime.InstanceConnection.Protocols; // Required for TcpCommunicator return type

// Changed namespace to reflect new location
namespace Sakurarin.UnityMcpServer.Runtime.Testing.Mocks
{
    /// <summary>
